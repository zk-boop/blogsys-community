  <template>
    <div class="search">
      ...
      <div class="search-header">
        <el-input v-model="keyword" placeholder="搜索文章..." class="search-input" @keyup.enter="handleSearch">
          <template #suffix>
            <el-button class="search-button" size="small" type="primary" @click="handleSearch">
              搜索
            </el-button>
          </template>
        </el-input>
      ...
      <div v-else class="search-results">
        <p class="result-count">共找到 {{ total }} 篇与 "{{ keyword }}" 相关的文章</p>
        <!-- 使用v-for直接渲染文章卡片，而不是使用ArticleCard组件 -->
        <div
        ...
        >
          <div class="article-card-layout">
            <div class="article-content">
              ...
              <p class="article-excerpt">{{ article.excerpt || article.summary || (article.content ?
                article.content.substring(0, 150) + '...' : '') }}</p>
